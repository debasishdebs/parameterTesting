...
def method1(start_time, end_time, dataset):
    ...
    for key in dataset.keys():
        if data_removal_start <= key <= data_removal_end:
            del b_dataset[key]
    print(len(b_dataset))
    return b_dataset
    ...
    for i in range(len(ts_list)-1):
        ...
        if hours >= 7:
            ...
            if choice == '2':
                ...
                table = 'balanced_manual_new_small_ds1_tse_temporal_lookback4_method1'
            elif choice == '2':
...
if __name__ == '__main__':
    remove_points('new_small_ds1_tse_temporal_lookback4_balanced')